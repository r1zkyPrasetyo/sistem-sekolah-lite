<?php  
$queryPeg = "SELECT * FROM pegawai";
$sqlPeg = mysqli_query($conn, $queryPeg)or die(mysqli_error("Error: " . $conn));
?>
 ...
 <!-- Page Heading -->
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="#" class="d-none d-sm-inline-block btn btn-primary shadow-sm"><i class="fas fa-user-plus fa-sm text-white-50"></i> Tambah Pegawai Baru</a>
          </div>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-6 col-xs-6">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Data Pegawai Aktif</h6>
                  ...
                  <div class="table-responsive-md table-responsive-sm">
                    <table id="table1" class="table table-sm table-striped table-bordered" style="width:100%">
                      ...
                      <tbody>
                        <?php  
                        $no = 1;
                        while($data = mysqli_fetch_assoc($sqlPeg)):
                        ?>
                          <tr>
