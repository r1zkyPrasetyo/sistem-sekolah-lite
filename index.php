...
<html lang="en">
  <head>
    ...
    <!-- datatable -->
    <link rel="stylesheet" type="text/css" href="<?=base_url('assets/node_modules/datatables.net-bs4/css/dataTables.bootstrap4.min.css');?>">
...
<body id="page-top">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <img class="img-profile rounded-circle" src="assets/img/photo.jpeg">
              </a>
  ...
  <!-- Page level plugins -->
  <script src="<?=base_url('assets/node_modules/chart.js/dist/Chart.bundle.min.js');?>"></script>
